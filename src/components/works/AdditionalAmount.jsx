...
export const AdditionalAmount = () => {
    return (
        <div style={{padding: '2rem 3rem'}}>
            ...
            <p style={{padding: '2rem 0', textAlign: 'left'}}>Una vez registrado en efectigo.com.mx y luego de efectuar una revisión automatizada de tus datos, podemos ofrecerte una cantidad adicional al préstamo existente. Esta posibilidad estará disponible en tu perfil personal una vez que inicies sesión. ¡Si quieres conocer tus opciones de montos adicionales disponibles, por favor revisa tu perfil en efectigo.com.mx!</p>
