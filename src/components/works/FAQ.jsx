...
const questions = [
    ...
    '¿Cómo puedo ingresar a mi perfil personal de efectigo.com.mx?',
...
const answers = [
    'Si eres cliente nuevo da clic en Solicítalo Ya y completa la solicitud del préstamo. Una vez registrado para ingresar a tu perfil deberás seleccionar ¿Ya eres cliente?, elige el monto, periodicidad de pago, así como plazo de tu conveniencia y sigue las instrucciones. Cualquier duda, por favor, comunícate con nuestro Equipo de Servicio al Cliente mediante WhatsApp o bien, llamando al (0155) 6717 0755 de lunes a Viernes de 8:00-20:00 y Sábados de 8:00 a 14:00 o contáctanos en info@efectigo.com.mx',
    ...
    'Debes subir las fotos (frente y reverso) de tu identificación oficial (IFE/INE), en formato de imagen, por favor no envíes PDF. Puedes hacerlo a través de tu perfil en el portal efectigo.com.mx, WhatsApp o bien, enviarla a documentos@efectigo.com.mx. En caso de que la Credencial de Elector no contenga la dirección, te solicitaremos un comprobante de domicilio (luz agua o teléfono no mayor a 3 meses). Por último, deberás enviarnos un recibo de nómina timbrado por el SAT más reciente, estado de cuenta o bien, declaración de impuestos.',
    'Puedes solicitar un préstamo desde 3,000 pesos y hasta un máximo de 9,000 pesos. El monto disponible es determinado en forma individual para cada uno de nuestros clientes. Puedes revisar tu límite de préstamo disponible ingresando a tu perfil en efectigo.com.mx',
    'Puedes solicitar un préstamo por un plazo de hasta 3 meses, pero no menor a 1 mes.',
    'Una vez que has solicitado tu préstamo puedes ingresar a tu perfil en efectigo.com.mx y solicitar un monto adicional siempre y cuando no sobrepases tu límite de crédito y tu primer parcialidad se encuentre cubierta. Si tu límite ha sido alcanzado debes realizar el pago de tu siguiente parcialidad antes de solicitar más dinero.',
    'Con efectiGO puedes recibir tu dinero fácil y sencillo: Por transferencia, directamente a tu cuenta bancaria mediante el uso de CLABE o Número de tarjeta de débito. (Dinero disponible en minutos una vez aprobado el préstamo).',
    ...
    'Si ya eres cliente y ya tienes un perfil, haz clic en el botón ¿Ya eres cliente?, en la parte superior derecha de la página de inicio. Una vez ahí, sólo debes ingresar tu dirección de correo electrónico, contraseña y listo. Si eres cliente nuevo, selecciona el monto, periodicidad de pago y plazo que deseas solicitar en la calculadora efectiGo y haz clic en el botón "Solicítalo ya", automáticamente serás direccionado a la página de Registro. Una vez ahí completa los campos necesarios para registrarte y crear tu perfil personal.',
    ...
    'Si crees que necesitas más tiempo para pagar tu préstamo, por favor, ingresa a tu perfil en efectigo.com.mx y consulta la opción de recorrer la fecha de pago de tu parcialidad, solo si tu primer parcialidad se encuentra pagada y no hayas utilizado este beneficio en tu parcialidad anterior.',
    'Ingresa a tu perfil en efectigo.com.mx y solicita el cambio de la información que necesites. Por seguridad, te haremos llegar un código PIN a tu correo o celular a fin de validar cualquier cambio. ',
