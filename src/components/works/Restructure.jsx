            ...
            <div className='numbers-work'>
                <div>
                    <ol className='numbers-work'>
                        ...
                        <li><p><strong>Formas de pago:</strong><br/>El cargo se realizará directamente a la cuenta registrada en tu perfil EfectiGO sólo debes ingresar y solicitar esta opción o bien, para solicitarlo con nosotros vía WhatsApp comunícate al 55 67717 0755. Si tu cuenta presenta algún imprevisto</p></li>
                    </ol>
                </div>
            </div>
        </div>
