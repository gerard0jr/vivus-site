    ...
    return (
        <div>
            ...
            <ol className='numbers-work'>
                ...
                <li><p>Luego de brindar toda la información solicitada, <strong>espera unos momentos por nuestra confirmación.</strong> Si la solicitud es aprobada, serás informado en tu perfil en efectigo.com.mx y también mediante un correo electrónico y mensaje de texto. El dinero solicitado será transferido a tu cuenta bancaria o en efectivo a la brevedad.</p></li>
            </ol>
