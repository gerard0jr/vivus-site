        ...
        <div className='pagar-container'>
            {cargos === 'resumen' || cargos === 'liquidate' ? 
                <div>
                    ...
                    <div className='pagar-text-box'><p>Despreocúpate ya tenemos programado el cargo de tu parcialidad para que no hagas filas ni pagues comisiones extra en los establecimientos</p></div>
                    <div className='liquidar-prestamo'>
                        <span>Selecciona aquí si quieres</span>
                        <button onClick={() => setCargos('liquidate')} className={cargos === 'liquidate' ? 'dashboard-gray-button active-dash-button' : 'dashboard-gray-button'}>Liquidar préstamo</button>
                    </div>
